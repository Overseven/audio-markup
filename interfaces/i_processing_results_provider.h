#ifndef I_PROCESSING_RESULTS_PROVIDER_H
#define I_PROCESSING_RESULTS_PROVIDER_H
...
//    virtual QVector<QString> get_files_list() = 0;
    ...
    virtual bool connect_to_signal_results_list_changed(QObject* pReceiver, const char* pszSlot, bool bConnect) const = 0;
//    virtual bool connect_to_signal_selection_changed(QObject* pReceiver, const char* pszSlot, bool bConnect) const = 0;
};

#endif // I_PROCESSING_RESULTS_PROVIDER_H
